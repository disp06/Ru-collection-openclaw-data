...
| [lukax/openclaw-agent-template](https://github.com/lukax/openclaw-agent-template) | Other | RU doc | OpenClaw template: Frontend Developer Agent with Vite + React + TypeScript starter | Proto | 1 |
...
| [Taotie2002/agent-main](https://github.com/Taotie2002/agent-main) | Other | RU doc | OpenClaw Main Agent Workspace | Proto | 0 |
| [comment-io/openclaw-plugin](https://github.com/comment-io/openclaw-plugin) | Other | RU doc | Comment.io Official OpenClaw Plugin | Proto | 0 |
| [kevinmalana/openclaw-skills](https://github.com/kevinmalana/openclaw-skills) | Agent Skill/Tool | RU doc | Kevin Malana OpenClaw multi-agent skills toolkit | Proto | 0 |
| [ShakerFunkhouser/moral-sentry](https://github.com/ShakerFunkhouser/moral-sentry) | Other | RU doc | An Objectifiabilist OpenClaw plugin that flags and blocks agent actions that diverge from user priorities. | Proto | 0 |
| [max411008/openclaw-dashboard](https://github.com/max411008/openclaw-dashboard) | Other | RU doc | openclaw-dashboard | Proto | 0 |
| [Ismaeliki11/OpenClaw-TaskManager](https://github.com/Ismaeliki11/OpenClaw-TaskManager) | Other | RU doc | Unspecified | Proto | 0 |
| [krownsh/openclaw-portal-content](https://github.com/krownsh/openclaw-portal-content) | Other | RU doc | Content repo: Markdown outputs from OpenClaw tasks for the portal. | Proto | 0 |
| [Lefreire2/biblioteca-openclaw](https://github.com/Lefreire2/biblioteca-openclaw) | Other | RU doc | Unspecified | Proto | 0 |
| [xDarkicex/openclaw-memory-libravdb](https://github.com/xDarkicex/openclaw-memory-libravdb) | Other | RU doc | Persistent local memory engine for OpenClaw — replaces default memory-lancedb with a full context lifecycle: hybrid vect... | Proto | 0 |
| [gudbot-comics/openclaw-news](https://github.com/gudbot-comics/openclaw-news) | Other | RU doc | openclaw openai news | Proto | 0 |
| [xiaojiou176-open/Switchyard](https://github.com/xiaojiou176-open/Switchyard) | Other | RU doc | Shared provider runtime for AI apps. | Proto | 0 |
| [Lee93whut/openclaw](https://github.com/Lee93whut/openclaw) | Other | RU doc | 保存龙虾数据 | Proto | 0 |
| [loganclaw9000/openclaw-state](https://github.com/loganclaw9000/openclaw-state) | Other | RU doc | Unspecified | Proto | 0 |
...
| [shuijiang888/openclaw-skills-private](https://github.com/shuijiang888/openclaw-skills-private) | Agent Skill/Tool | RU doc | waterjiang的sharecrm skill 2026-03-21 | Proto | 0 |
